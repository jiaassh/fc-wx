...
var invite_others = appData.invite_others;
var house_people = appData.house_people;
var house_manage = appData.house_manage;
var getcity = appData.getcity;
var getallvillage = appData.getallvillage;
var visitor_owner = appData.visitor_owner;
var bld_index = appData.bld_index;
...
apiRoutes.get('/information',function(req,res){
  res.json({
    errno:0,
    data:information
  })
...
apiRoutes.get('/invite_others',function(req,res){
  res.json({
    errno:0,
    data:invite_others
  })
});
apiRoutes.get('/house_people',function(req,res){
  res.json({
    errno:0,
    data:house_people
  })
});
apiRoutes.get('/house_manage',function(req,res){
  res.json({
    errno:0,
    data:house_manage
  })
...
});apiRoutes.get('/getallvillage',function(req,res){
  res.json({
    errno:0,
    data:getallvillage
  })
});
apiRoutes.get('/visitor_owner',function(req,res){
  res.json({
    errno:0,
    data:visitor_owner
  })
});
apiRoutes.get('/bld_index',function(req,res){
  res.json({
    errno:0,
    data:bld_index
  })
