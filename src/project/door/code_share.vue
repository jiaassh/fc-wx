        ...
        <div style="background-color:white" class="containers" id="containers" ref="abc">
          ...
          <div class="fk_outer_div">
            ...
            <div class="inner_div_1">
              <img v-if="inviteData.pic.length==0" style="width:100%;height:100%;" src="http://192.168.0.24:8080/o2o/door/qrcodeImg/151038341600590499675-a745-4dec-a3dc-5eedc861b92e.png"/>
              <img v-if="inviteData.pic.length!=0" style="width:100%;height:100%;" :src="inviteData.pic"/>
            </div>
            <!--文字-->
            <div class="inner_div_2">
              <h2 ref="this_position" class="text_center">
                {{inviteData.position.val}}
              </h2>
              <div class="weui_flex third_font third_font_margin">
                <div>有效期至</div>
                <div class="text_right this_flex_1" id="timevalue">{{inviteData.time.val}}</div>
              </div>
              <div class="weui_flex third_font third_font_margin">
                <div>访客姓名</div>
                <div class="text_right this_flex_1">{{inviteData.name.val}}</div>
              </div>
              <div class="weui_flex third_font third_font_margin">
                <div>性别</div>
                <div class="text_right this_flex_1">{{inviteData.sex.val}}</div>
              </div>
              <div class="weui_flex third_font third_font_margin">
                <div>联系电话</div>
                <div class="text_right this_flex_1">{{inviteData.phone.val}}</div>
              </div>
...
<script>
  ...
  export default{
    ...
    mounted(){
      setTitle("二维码分享");
      this.inviteData = JSON.parse(this.$route.query.inviteData)
