<template>
  <div class="body">
    ...
    <div>
      ...
      <!--热门项目-->
      <div style="margin-top:-65px;" v-if="hot_project!==null">
    ...
    <alert v-model="confirm_show" title="提示" @on-hide="go_back"> {{confirm_content}}</alert>
  </div>
</template>
...
<script>
  ...
  import {Swiper,SwiperItem,Actionsheet,Alert} from 'vux';
  ...
  export default{
    ...
    components:{
      Swiper,Actionsheet,Cardswitch,SwiperItem,Alert
    },
   watch:{
     all_project:function(){
       console.log(123)
     }
   },
    mounted(){
