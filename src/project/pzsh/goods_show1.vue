<template>
  <div>
      <div :key="index" v-for="(item,index) in goods">
        <div class="weui_flex border_bottom_2" @click="showDetail(item.goods_id||item.order_id||item.id||item.ordernum,item.state)">
          ...
          <div class="ui_describe flex_1 posr font_14">
            ...
            <template v-if="type === '4'">
              <div style="max-height:47px;font-size:17px;overflow: hidden"><span style="font-size:13px;padding:2px 5px;border-radius:5px;border:1px solid #ad7de7;color:#ad7de7;margin-right:5px;vertical-align: baseline;">{{item.state_name}}</span>{{item.name}}</div>
