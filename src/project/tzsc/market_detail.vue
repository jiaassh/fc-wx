    ...
    <div>
      <div class="padding_bottom">
        ...
        <div class="describe body_white">
          ...
          <div class="overflow_hidden"><p class="font_price">￥{{price.toFixed(2)}}</p><p class="font_sale">{{degree}}</p></div>
        ...
        <group gutter="10px">
          ...
          <div style="padding:5px 15px 5px 0;margin-left:15px;border-top:1px solid #ececec;font-size:15px;font-weight:normal;"><pre>{{goods_content}}</pre></div>
        </group>
        <group gutter="10px">
      ...
      <div class="fixed_bottom" v-if="!isreg">
        <div class="weui_flex" style="padding:0;text-align:center;height:44px;">
          <a v-if="state===0" style="flex:2;border-right:1px solid #ececec;" @click="thumbs_up"><div style="height: 24px"><img style="height: 24px" src="./点赞.png"/><span style="vertical-align: top;margin-left:8px;font-size:20px;color:#b2b2b2">{{praisecount}}</span></div></a>
          <a v-else style="flex:2;border-right:1px solid #ececec;" @click="thumbs_up"><div style="height: 22px"><img style="height: 25px" src="./点赞2.png"/><span style="vertical-align: top;margin-left:8px;font-size:20px;color:#b2b2b2">{{praisecount}}</span></div></a>
          <a :href="'tel:'+tel" class="cz_button color_orangered" style="flex:4;color:white">拨打电话</a>
          <a @click="showActionsheet()" class="cz_button color_orange" style="flex:4;color:white">评论</a>
        </div>
      </div>
    </div>
