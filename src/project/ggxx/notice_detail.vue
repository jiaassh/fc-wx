<template>
  <div>
    <div style="padding:15px;">
      ...
      <div style="margin:10px 0;" v-html="content.val" class="kongzhi"></div>
      ...
      <div v-if="!isreg">
        ...
        <div v-if="isenroll==='1'" style="margin:20px 0 10px"><x-button type="primary" class="zj_button" @click.native="gonext">查看详情</x-button></div>
      </div>
    </div>
      ...
      if(service_url){
        this.$http.get(service_url+"/o2o/notice/wx/detail?noticeid="+this.noticeid+"&vid="+userProfile.vid).then((data) => {
          if(data.body.status==="ok"){
            ...
            self.isenroll==='2'?setTitle("活动详情"):setTitle("公告详情");
